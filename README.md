...
- 추천시스템 구현 방법
    ...
    이후 각 유사도 값이 모두 0.9 이상이고, 해당 기간동안의 수익이 사용자가 실제 얻은 수익보다 높을 때 추천하도록 함.
    ...
    [
        [
            ...
            },
            {
                ...
                "better": 23400.0,
                "rateVO": {
                    "rate": 0.9468943782505536,
                    "priceRate": 0.9968671997416683,
                    "volumeRate": 0.93151561373974,
                    "priceSdRate": 0.9123003212702523
                }
            },
            {
                "start": {
                ...
                "better": 22650.0,
                "rateVO": {
                    "rate": 0.9952600676738732,
                    "priceRate": 0.9956469243889232,
                    "volumeRate": 0.9915535516164464,
                    "priceSdRate": 0.9985797270162499
                }
            }
        ],
        [
